...
{
    internal class IndieBuff_FileChunker
    {
        ...
        public IndieBuff_FileChunker(List<UnityEngine.Object> contextObjects, int maxTokenCount = int.MaxValue, bool includeConsoleLogs = false)
        {
