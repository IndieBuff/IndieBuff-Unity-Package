...
csharp_code = open("C:/Users/David/Work/FULLTIMEJOB/IndieBuff/Froglet-Cosmic-Shore/Assets/_Scripts/Game/Assemblers/GyroidBondMateDataContainer.cs", "r").read()
...
for chunk in chunker(tree, csharp_code):
    print(chunk.extract_lines(csharp_code) + "\n\n====================\n\n")